...
public class CheckoutPresenter {
    ...
    public CheckoutPresenter (GlobalPresenter globalPresenter){
        this.globalPresenter = globalPresenter;
    }

    public void doCheckout(String token, int customer_id, double lat, double lng, String address, String date_time, int plan_id){
        ...
        ApiConnection.getInstance().getRoutes().doCheckout("Bearer ".concat(token), data).enqueue(new Callback<Message>() {
            @Override
